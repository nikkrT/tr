...
func (h *ProductRepo) Create(ctx context.Context, product models.Product) (int, error) {
...
func (h *ProductRepo) ReadById(ctx context.Context, id int) (models.Product, error) {
	...
	if err != nil {
		return models.Product{}, fmt.Errorf("scan err: %w", err)
	}
	if product.Id == 0 {
...
func (h *ProductRepo) ReadAll(ctx context.Context, filtered string) ([]models.Product, error) {
...
func (h *ProductRepo) Update(ctx context.Context, product models.Product) error {
